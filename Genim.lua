...
local Genim = loadstring(game:HttpGet("https://raw.githubusercontent.com/raphaelsancho21-byte/Genim-Libary/refs/heads/main/Genim.lua?t=" .. os.time()))()
